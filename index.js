...
var AnchorizableText = function (_Component) {
  _inherits(AnchorizableText, _Component);

  function AnchorizableText(props) {
    _classCallCheck(this, AnchorizableText);

    var _this = _possibleConstructorReturn(this, (AnchorizableText.__proto__ || Object.getPrototypeOf(AnchorizableText)).call(this, props));

    var contents = _this._expandByRules([_this.props.text]).map(function (replacer, i) {
      if (typeof replacer === 'string') return _react2.default.createElement(
        'span',
        { key: i },
        replacer
      );
      if (typeof replacer.replace == 'function') {
        setTimeout(function () {
          return replacer.replace.bind(_this)(i, replacer.value);
        });
      }
      var tmp = replacer.wrap.bind(_this)(replacer.value);
  ...
  _createClass(AnchorizableText, [{
    ...
    key: 'replaceContentsOf',
    value: function replaceContentsOf(index, content) {
      this.state.contents[index] = content;
      this.setState({ contents: this.state.contents });
    }
  }]);

  return AnchorizableText;
}(_react.Component);
...
AnchorizableText.Replacer = function (substr) {
  ...
  this.wrap = function (sub) {
    return _react2.default.createElement("a", { href: sub, target: "_blank" }, sub);
  };
};

exports.default = AnchorizableText;
